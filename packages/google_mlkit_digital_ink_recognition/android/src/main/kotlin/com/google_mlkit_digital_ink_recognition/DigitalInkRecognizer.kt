...
class DigitalInkRecognizer: MethodChannel.MethodCallHandler {
    ...
    private fun handleInkDetectionIfModelDownloaded(call: MethodCall, result: MethodChannel.Result, model: DigitalInkRecognitionModel) {
        val id = call.argument<String>("id")!!
        val recognizer = instances.getOrPut(id) {
    ...
    private fun process(recognitionResult: RecognitionResult, result: MethodChannel.Result) {
        val candidateList = recognitionResult.candidates.map { candidate ->
            mapOf(
    ...
    private fun getModel(tag: String, result: MethodChannel.Result) : DigitalInkRecognitionModel? {
    ...
    private fun manageModel(call: MethodCall, result: MethodChannel.Result) {
