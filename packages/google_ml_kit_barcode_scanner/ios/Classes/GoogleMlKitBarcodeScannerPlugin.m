#import "GoogleMlKitBarcodeScannerPlugin.h"
...
@implementation GoogleMlKitBarcodeScannerPlugin {
    MLKBarcodeScanner *barcodeScanner;
}

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"google_ml_kit_barcode_scanner"
                                     binaryMessenger:[registrar messenger]];
    GoogleMlKitBarcodeScannerPlugin* instance = [[GoogleMlKitBarcodeScannerPlugin alloc] init];
