...
// This Package.swift provides Swift Package Manager support for google_mlkit_text_recognition.
...
let package = Package(
  ...
  targets: [
    .target(
      name: "google_mlkit_text_recognition",
      dependencies: [
        .product(name: "MLKitTextRecognition", package: "GoogleMLKitSwiftPM"),
        .product(name: "MLKitTextRecognitionCommon", package: "GoogleMLKitSwiftPM"),
