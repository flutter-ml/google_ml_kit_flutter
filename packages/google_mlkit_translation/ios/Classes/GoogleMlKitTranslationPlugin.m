...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  ...
  GoogleMlKitTranslationPlugin *instance =
      [[GoogleMlKitTranslationPlugin alloc] init];
...
- (MLKTranslator *)initialize:(FlutterMethodCall *)call {
  ...
  MLKTranslatorOptions *options =
      [[MLKTranslatorOptions alloc] initWithSourceLanguage:source
                                            targetLanguage:target];
  return [MLKTranslator translatorWithOptions:options];
}

- (void)handleTranslation:(FlutterMethodCall *)call
                   result:(FlutterResult)result {
...
- (void)manageModel:(FlutterMethodCall *)call result:(FlutterResult)result {
  ...
  MLKTranslateRemoteModel *model =
      [MLKTranslateRemoteModel translateRemoteModelWithLanguage:modelTag];
