...
class RemoteModelView extends StatelessWidget {
  ...
  Future<void> downloadModel() async {
    var result = await _remoteModelManager
        .downloadModel('bird-classifier', isWifiRequired: false);
    print('Model downloaded: $result');
  }

  Future<void> deleteModel() async {
    var result =
        await _remoteModelManager.deleteModel('bird-classifier');
  ...
  Future<void> isModelDownloaded() async {
    var result = await _remoteModelManager
        .isModelDownloaded('bird-classifier');
